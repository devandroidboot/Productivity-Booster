package com.codegama.productivity_booster.adapter;
...
import com.codegama.productivity_booster.activity.TaskActivity;
...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public TaskAdapter(Fragment context, List<Task> taskList, CreateTaskBottomSheetFragment.setRefreshListener setRefreshListener) {
        this.context = context;
        this.taskList = taskList;
        this.setRefreshListener = setRefreshListener;
        this.inflater = (LayoutInflater) context.requireContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }
    ...
    public void showPopUpMenu(View view, int position) {
        ...
        PopupMenu popupMenu = new PopupMenu(context.getContext(), view);
        popupMenu.getMenuInflater().inflate(R.menu.menu, popupMenu.getMenu());
        popupMenu.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                /*
                case R.id.menuDelete:
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context.getContext(), R.style.AppTheme_Dialog);
                ...
                case R.id.menuUpdate:
                    ...
                    createTaskBottomSheetFragment.setTaskId(task.getTaskId(), true, (TaskActivity)context.getActivity(), (TaskActivity)context.getActivity());
                    createTaskBottomSheetFragment.show(context.getActivity().getSupportFragmentManager(), createTaskBottomSheetFragment.getTag());
                    break;
                case R.id.menuComplete:
                    AlertDialog.Builder completeAlertDialog = new AlertDialog.Builder(context.getContext(), R.style.AppTheme_Dialog);
    ...
    public void showCompleteDialog(int taskId, int position) {
        Dialog dialog = new Dialog(context.getContext(), R.style.AppTheme);
    ...
    private void deleteTaskFromId(int taskId, int position) {
        class GetSavedTasks extends AsyncTask<Void, Void, List<Task>> {
            ...
            protected List<Task> doInBackground(Void... voids) {
                DatabaseClient.getInstance(context.getContext())
                        .getAppDatabase()
                        .dataBaseAction()
